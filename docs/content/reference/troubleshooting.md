...
Most of these come down to network reality or how exercism serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

exercism rate-limits like any public site. exercism already paces
...
Where a surface is gated, exercism reads a cookie or token you supply
...
`exercism`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what exercism actually did
